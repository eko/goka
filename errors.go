...
var (
	...
	// * github.com/eko/goka/processor.go
	// * github.com/eko/goka@v1.0.0/view.go
	// * github.com/some-fork/goka/view.go
	// examples which do not match
	// * github.com/something/else
	// * github.com/eko/goka/subpackage/file.go
	...
	// reflect.TypeOf(Processor{}).PkgPath() returns (in the main repo) "github.com/eko/goka"
